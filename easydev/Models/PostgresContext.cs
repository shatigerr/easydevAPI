...
public partial class PostgresContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("Database_pkey");
            ...
            entity.Property(e => e.Dbengine).HasColumnName("DBEngine");
        ...
        {
            entity.HasKey(e => e.Id).HasName("Endpoint_pkey");
        ...
        modelBuilder.Entity<Project>(entity =>
        {
            ...
            entity.HasIndex(e => e.Id, "project_id_key").IsUnique();
